...
@section('title', 'Нов администратор')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="p-6 border-b">
            <h1 class="text-xl font-bold text-gray-800">Създаване на нов администратор</h1>
            <p class="text-gray-600 mt-1">Този потребител ще има пълен достъп до админ панела</p>
        </div>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t">
                ...
                <button type="submit" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition">
                    <i class="fa-solid fa-save mr-2"></i>Създай администратор
                </button>
            </div>
        </form>
    </div>
